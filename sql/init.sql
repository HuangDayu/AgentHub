...
-- 1. System Roles
-- =========================================================
INSERT INTO app.role_def (id, role_code, role_name, role_type)
...
-- 2. Tenants
-- =========================================================
INSERT INTO app.tenant (id, tenant_code, name, plan_code, isolation_level, status, region, created_at, updated_at)
...
-- 3. Workspaces
-- =========================================================
INSERT INTO app.workspace (id, tenant_id, workspace_code, name, region, status, created_at)
...
-- =========================================================
INSERT INTO app.app_user (id, tenant_id, username, email, display_name, status, auth_source, password_hash)
...
INSERT INTO app.role_binding (id, user_id, role_id, created_at)
