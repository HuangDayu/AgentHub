...
public class StudioClient {
     ...
     */
    public StudioClient(StudioConfig config, AgentStudioMessageHandler agentStudioMessageHandler) {
        this.config = config;
        this.agentStudioMessageHandler = agentStudioMessageHandler;
        ...
        return executeWithRetry(
                Mono.fromCallable(
                        () -> {
                            ...
                            agentStudioMessageHandler.registerRun(payload);
                            return null;
                        }));
    }
                        ...
                        () -> {
                            ...
                            PushMessageRequest payload =
                                    PushMessageRequest.builder()
                                            ...
                                            .msg(msg)
                                            .build();
                            agentStudioMessageHandler.pushMessage(payload);
                            return null;
                        }));
    }
        ...
        return executeWithRetry(
                Mono.fromCallable(
                        () -> {
                            ...
                            agentStudioMessageHandler.requestUserInput(payload);
                            return requestId;
                        }));
    }
