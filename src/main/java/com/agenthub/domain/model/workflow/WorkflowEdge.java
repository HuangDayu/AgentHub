...
public class WorkflowEdge {
    ...
    public static WorkflowEdge create(String sourceNodeId, String targetNodeId) {
        return new WorkflowEdge(randomId(), sourceNodeId, targetNodeId);
    }
     ...
     * @return 工作流边实例
     */
    public static WorkflowEdge createWithCondition(String sourceNodeId, 
                                                   String targetNodeId, 
                                                   String condition) {
        WorkflowEdge edge = new WorkflowEdge(randomId(), sourceNodeId, targetNodeId);
