...
public class Workflow {
    ...
    private Workflow(String id, String tenantId, String workspaceId, String workflowCode,
    ...
    public static Workflow create(String tenantId, String workspaceId, String workflowCode,
                                  String name, String description, String graphDefinition) {
        return new Workflow(randomId(), tenantId, workspaceId, workflowCode,
