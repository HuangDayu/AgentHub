...
public record McpTool(
    ...
    public static McpTool create(String id, String tenantId, String workspaceId,
        ...
        return new McpTool(id, tenantId, workspaceId, name.trim(), description,
                serverUrl, serverType, command, args, env, enabled, now, now);
    }
    ...
    public McpTool patch(String name, String description, String serverUrl,
        ...
        return new McpTool(this.id, this.tenantId, this.workspaceId,
                ...
                resolveCommand(command), resolveArgs(args), resolveEnv(env),
    ...
    private String resolveDescription(String desc) { return desc == null ? this.description : desc; }
    private String resolveServerUrl(String url) { return url == null ? this.serverUrl : url; }
    private ServerType resolveServerType(ServerType type) { return type == null ? this.serverType : type; }
    private String resolveCommand(String cmd) { return cmd == null ? this.command : cmd; }
    private List<String> resolveArgs(List<String> args) { return args == null ? this.args : args; }
    private Map<String, String> resolveEnv(Map<String, String> env) { return env == null ? this.env : env; }
