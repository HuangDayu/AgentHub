...
public class RagCrossEncoderRerankerAdapter implements RagRerankerPort {
    private static final Logger log = LoggerFactory.getLogger(RagCrossEncoderRerankerAdapter.class);
    ...
    public RagCrossEncoderRerankerAdapter(RestTemplate restTemplate) {
