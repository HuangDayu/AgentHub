 ...
 */
@Component
public class ElasticsearchRagTextSearchAdapter implements RagTextSearchPort {
    private static final Logger log = LoggerFactory.getLogger(ElasticsearchRagTextSearchAdapter.class);
     ...
     * 构造函数。
     */
    public ElasticsearchRagTextSearchAdapter(
