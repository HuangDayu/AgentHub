 ...
 */
@Component
public class SpringRagVectorSearchAdapter implements RagVectorSearchPort {
    private static final Logger log = LoggerFactory.getLogger(SpringRagVectorSearchAdapter.class);
     ...
     */
    public SpringRagVectorSearchAdapter(SpringAiObjectPoolManager springAiObjectPoolManager) {
