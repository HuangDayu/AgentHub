...
@Component
public class SpringRagModelChatAdapter implements RagModelChatPort {
    private static final Logger log = LoggerFactory.getLogger(SpringRagModelChatAdapter.class);
    private final SpringAiObjectPoolManager springAiObjectPoolManager;

    public SpringRagModelChatAdapter(SpringAiObjectPoolManager springAiObjectPoolManager) {
