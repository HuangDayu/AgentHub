...
public class SpringRagRetrievalAdapter implements RagRetrievalPort {
    private static final Logger log = LoggerFactory.getLogger(SpringRagRetrievalAdapter.class);
