...
public class KeywordRagRerankerAdapter implements RagRerankerPort {

    private static final Logger log = LoggerFactory.getLogger(KeywordRagRerankerAdapter.class);
