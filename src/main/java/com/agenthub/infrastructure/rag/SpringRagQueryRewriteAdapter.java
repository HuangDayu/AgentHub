 ...
 */
@Component
public class SpringRagQueryRewriteAdapter implements RagQueryRewritePort {

    private static final Logger log = LoggerFactory.getLogger(SpringRagQueryRewriteAdapter.class);


    private final SpringAiObjectPoolManager springAiObjectPoolManager;

    public SpringRagQueryRewriteAdapter(SpringAiObjectPoolManager springAiObjectPoolManager) {
