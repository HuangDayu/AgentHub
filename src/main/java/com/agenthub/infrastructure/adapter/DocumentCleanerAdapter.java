 ...
 */
@Component
public class DocumentCleanerAdapter implements DocumentCleanerPort {

    private static final Logger log = LoggerFactory.getLogger(DocumentCleanerAdapter.class);
