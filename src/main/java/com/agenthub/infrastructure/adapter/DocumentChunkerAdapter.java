 ...
 */
@Component
public class DocumentChunkerAdapter implements DocumentChunkerPort {

    private static final Logger log = LoggerFactory.getLogger(DocumentChunkerAdapter.class);
