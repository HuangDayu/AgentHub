...
import com.agenthub.application.port.out.rag.TextSearchPort;
 ...
 */
@Component
public class ElasticsearchTextSearchAdapter implements TextSearchPort {
    private static final Logger log = LoggerFactory.getLogger(ElasticsearchTextSearchAdapter.class);
     ...
     * 构造函数。
     */
    public ElasticsearchTextSearchAdapter(
