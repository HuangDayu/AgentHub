package com.agenthub.infrastructure.persistence.files;
 ...
 * 基于 MinIO 的文档存储适配器。
 *
 * <p>该类实现了 {@link DocumentFileStoragePort} 接口，使用 MinIO 作为后端存储。
 ...
 *
 * @author agenthub
 * @see DocumentFileStoragePort
 */
@Component
public class MinioDocumentFileStorageAdapter implements DocumentFileStoragePort {

    private static final Logger log = LoggerFactory.getLogger(MinioDocumentFileStorageAdapter.class);
     ...
     */
    public MinioDocumentFileStorageAdapter(
