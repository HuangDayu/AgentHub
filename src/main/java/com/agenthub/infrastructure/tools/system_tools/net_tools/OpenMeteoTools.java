...
package com.agenthub.infrastructure.tools.system_tools.net_tools;
...
public class OpenMeteoTools {
    ...
    public String getWeatherForecastByLocation(@ToolParam(description = "纬度") double latitude,
        ...
        weatherInfo.append(String.format(OpenMeteoTools.WEATHER_INFO, current.temperature(), temperatureUnit, current.feelsLike(), temperatureUnit,
        ...
        for (int i = 0; i < daily.time().size(); i++) {
            ...
            weatherInfo.append(String.format(WEATHER_BASE_INFO, formattedDate, tempMin, temperatureUnit, tempMax, temperatureUnit,
    ...
    public String getAirQuality(@ToolParam(description = "纬度") double latitude,
        ...
        try {
            ...
            // 构建空气质量信息字符串
            String aqiInfo = String.format(AIR_QUALITY_INFO, latitude, longitude, weatherData.timezone(), europeanAqi, aqiLevel, usAqi, usAqiLevel, pm10,
                    pm25, co, no2, so2, o3);
