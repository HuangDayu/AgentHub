package com.agenthub.infrastructure.tools.system_tools.spring;
 ...
 */
@Configuration
public class SystemToolsConfiguration {


    /**
     * 自动注册容器中所有注解了@AgentTools的Bean的Tools
     *
     * @param applicationContext
     * @return
     */
    @Bean
    public ToolCallbackProvider systemToolCallbackProvider(ApplicationContext applicationContext, SystemToolsFactory systemToolsFactory) {
        ...
        systemToolsFactory.addToolCallback(List.of(callbackProvider.getToolCallbacks()));
