...
import com.agenthub.infrastructure.tools.core_tools.dto.ProcessResult;
...
/**
 * 命令行工具，提供命令执行、进程管理和代码执行功能。
 */
@RequiredArgsConstructor
@AgentTools(name = "CommandTools", description = "命令行工具，提供命令执行、进程管理和代码执行功能")
