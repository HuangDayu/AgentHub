...
import com.agenthub.infrastructure.tools.core_tools.dto.MemorySaveToolInput;
...
@AgentTools(name = "MemoryTools", description = "记忆工具，提供记忆的获取、搜索、保存和删除功能", defaultEnable = false)
