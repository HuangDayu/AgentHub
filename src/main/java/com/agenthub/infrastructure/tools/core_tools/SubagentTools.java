...
import com.agenthub.infrastructure.tools.core_tools.dto.CreateSubagentToolInput;
import com.agenthub.infrastructure.tools.core_tools.dto.SubagentHandleToolInput;
...
@AgentTools(name = "SubagentTools", description = "子智能体工具，提供子Agent的创建、控制、调度和查询功能")
