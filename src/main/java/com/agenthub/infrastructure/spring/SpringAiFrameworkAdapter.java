...
@Component
public class SpringAiFrameworkAdapter {
    private final SpringAiVectorStoreManager springAiVectorStoreManager;
    private final SpringAiModelManager springAiModelManager;
    ...
    public SpringAiFrameworkAdapter(SpringAiVectorStoreManager springAiVectorStoreManager,
                                    SpringAiModelManager springAiModelManager,
                                    KnowledgeBaseRepository knowledgeBaseRepository,
                                    ModelStrategyRepository modelStrategyRepository,
                                    JdbcChatMemoryRepository jdbcChatMemoryRepository) {
        this.springAiVectorStoreManager = springAiVectorStoreManager;
        this.springAiModelManager = springAiModelManager;
    ...
    public VectorStore getVectorStoreByKb(KnowledgeBase knowledgeBase) {
        EmbeddingModel embeddingModel = springAiModelManager.getOrCreateEmbeddingModel(knowledgeBase.embeddingModelConfigId());
    ...
    public VectorStore getVectorStoreByConfigId(String vectorStoreConfigId, EmbeddingModel embeddingModel) {
        VectorStore vectorStore = springAiVectorStoreManager.getOrCreate(vectorStoreConfigId, embeddingModel);
    ...
    public ChatModel getChatModelByConfigId(String chatModelConfigId) {
        ChatModel chatModel = springAiModelManager.getOrCreateChatModel(chatModelConfigId);
    ...
    public EmbeddingModel getEmbeddingModelByConfigId(String embeddingModelConfigId) {
        EmbeddingModel embeddingModel = springAiModelManager.getOrCreateEmbeddingModel(embeddingModelConfigId);
