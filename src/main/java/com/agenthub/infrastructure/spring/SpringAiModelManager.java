 ...
 */
@Component
public class SpringAiModelManager implements ModelManagerPort {
    private static final Logger log = LoggerFactory.getLogger(SpringAiModelManager.class);
    private final Map<String, Object> modelInstanceCache = new ConcurrentHashMap<>();
    private final ModelConfigRepository modelConfigRepository;
    private final ModelFactoryRegistry modelFactoryRegistry;

    public SpringAiModelManager(ModelConfigRepository modelConfigRepository, ModelFactoryRegistry modelFactoryRegistry) {
