...
import com.agenthub.infrastructure.spring.vector.VectorStoreFactory;
import com.agenthub.infrastructure.spring.vector.VectorStoreFactoryRegistry;
 ...
 */
@Service
public class SpringAiVectorStoreManager implements VectorStoreManagerPort {

    private static final Logger log = LoggerFactory.getLogger(SpringAiVectorStoreManager.class);
     ...
     * 构造动态向量存储管理器。
     */
    public SpringAiVectorStoreManager(VectorStoreFactoryRegistry vectorStoreFactoryRegistry, VectorStoreConfigRepository vectorStoreConfigRepository) {
