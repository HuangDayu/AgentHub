...
import com.agenthub.application.port.out.rag.VectorizationPort;
 ...
 */
@Component
public class SpringAiVectorizerAdapter implements VectorizationPort {
    private static final Logger log = LoggerFactory.getLogger(SpringAiVectorizerAdapter.class);
    ...
    public SpringAiVectorizerAdapter(SpringAiFrameworkAdapter springAiFrameworkAdapter) {
    ...
    public List<DocumentChunk> vectorize(String embeddingModelConfigId, List<DocumentChunk> chunks) {
        ...
        EmbeddingModel embeddingModel = springAiFrameworkAdapter.getEmbeddingModelByConfigId(embeddingModelConfigId);
