...
@Component
public class SpringAiChatClientAdapter implements ModelChatPort {
    private static final Logger log = LoggerFactory.getLogger(SpringAiChatClientAdapter.class);
    private final SpringAiFrameworkAdapter springAiFrameworkAdapter;

    public SpringAiChatClientAdapter(SpringAiFrameworkAdapter springAiFrameworkAdapter) {
    ...
    private ChatClient getChatClient(SessionMessage sessionMessage) {
        return springAiFrameworkAdapter.getChatClientBySessionId(sessionMessage);
    }
