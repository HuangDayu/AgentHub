 ...
 */
@Service
public class SpringAiVectorPoolManager implements VectorPoolManagerPort {

    private static final Logger log = LoggerFactory.getLogger(SpringAiVectorPoolManager.class);
     ...
     * 构造动态向量存储管理器。
     */
    public SpringAiVectorPoolManager(VectorStoreFactoryRegistry vectorStoreFactoryRegistry, VectorStoreConfigRepository vectorStoreConfigRepository) {
