...
import com.agenthub.application.port.out.rag.VectorSearchPort;
...
public class SpringAiVectorSearchAdapter implements VectorSearchPort {
    private static final Logger log = LoggerFactory.getLogger(SpringAiVectorSearchAdapter.class);
    private final SpringAiFrameworkAdapter springAiFrameworkAdapter;

    /**
     * 构造适配器。
     *
     * @param springAiFrameworkAdapter Spring AI 框架适配器
     */
    public SpringAiVectorSearchAdapter(SpringAiFrameworkAdapter springAiFrameworkAdapter) {
