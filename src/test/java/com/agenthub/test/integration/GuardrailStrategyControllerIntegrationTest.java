...
class GuardrailStrategyControllerIntegrationTest {
    ...
    void shouldCreateGuardrailStrategy() throws Exception {
        String responseBody = mockMvc.perform(post("/api/v1/workspaces/{workspaceId}/guardrail-strategies", WORKSPACE_ID)
    ...
    void shouldListGuardrailStrategies() throws Exception {
        mockMvc.perform(get("/api/v1/workspaces/{workspaceId}/guardrail-strategies", WORKSPACE_ID))
    ...
    void shouldGetGuardrailStrategyById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/workspaces/{workspaceId}/guardrail-strategies/{id}", WORKSPACE_ID, createdStrategyId))
                .andExpect(status().isOk())
    ...
    void shouldUpdateGuardrailStrategy() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/workspaces/{workspaceId}/guardrail-strategies/{id}", WORKSPACE_ID, createdStrategyId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
    ...
    void shouldReturnNotFoundForUnknownId() throws Exception {
        mockMvc.perform(get("/api/v1/workspaces/{workspaceId}/guardrail-strategies/{id}", WORKSPACE_ID, "00000000-0000-0000-0000-000000000001"))
    ...
    void shouldDeleteGuardrailStrategy() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/workspaces/{workspaceId}/guardrail-strategies/{id}", WORKSPACE_ID, createdStrategyId))
